...
export const projects = [
  ...
  },
  {
    ...
    category: "featured" as const,
    description:
      "Freelance short-form GTM guidance to reach the first 100 customers — ICP, positioning, demo strategy, acquisition motion and partner-led outreach for wholesalers, distributors and B2B brands on Shopify/Adobe Commerce.",
  ...
  },
  {
    ...
    category: "featured" as const,
    description:
      "Personal build project — pushed an Intel i9-9900K from a 4.7GHz stock boost to a stable 5.3GHz all-core overclock at zero AVX offset, Prime95-stable under a 360mm AIO.",
